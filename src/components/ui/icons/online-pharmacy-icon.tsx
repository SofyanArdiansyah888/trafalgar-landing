...
export default function OnlinePharmacyIcon({ ...props }: React.ComponentPropsWithoutRef<"svg">){
    return <svg {...props} xmlns="http://www.w3.org/2000/svg" width="62" height="85" viewBox="0 0 62 85" fill="none">
