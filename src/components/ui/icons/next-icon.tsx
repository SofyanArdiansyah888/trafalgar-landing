...
export default function NextIcon({...props}: React.ComponentPropsWithoutRef<"svg">) {
    return <svg {...props} xmlns="http://www.w3.org/2000/svg" width="15" height="9" viewBox="0 0 15 9" fill="none">
