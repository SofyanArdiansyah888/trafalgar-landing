...
export default function VectorIcon2({ ...props }: React.ComponentPropsWithoutRef<"svg">){
    return <svg {...props} xmlns="http://www.w3.org/2000/svg" width="478" height="516" viewBox="0 0 478 516" fill="none">
        <path
        ...
        <defs>
            <linearGradient id="paint0_linear_58_282" x1="287.009" y1="635.124" x2="468.152" y2="44.8754"
