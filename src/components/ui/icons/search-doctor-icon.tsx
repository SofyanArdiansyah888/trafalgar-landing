...
export default function SearchDoctorIcon({ ...props }: React.ComponentPropsWithoutRef<"svg">){
    return <svg {...props} xmlns="http://www.w3.org/2000/svg" width="92" height="90" viewBox="0 0 92 90" fill="none">
        <g clipPath="url(#clip0_23_156)">
            ...
            <path d="M46.7413 52.4206L37.8058 60.9423L36.9824 52.185L41.872 48.2007L46.7413 52.4206Z" fill="#3A81D6" fillOpacity="0.8"/>
